        ...
        try {
            ...
            switch (req.url) {
                ...
                case '/fetchPackage': {
                    try {
                        body = await bodyPromise;
                        const pkgResponse = store.fetchPackage(body.options); // eslint-disable-line
                ...
                case '/prune':
                    ...
                    break;
                case '/importPackage': {
                    const importPackageBody = (await bodyPromise); // eslint-disable-line @typescript-eslint/no-explicit-any
                ...
                case '/upload': {
                    ...
                    const uploadBody = (await bodyPromise); // eslint-disable-line @typescript-eslint/no-explicit-any
                ...
                case '/stop':
                    ...
                    (0, logger_1.globalInfo)('Got request to stop the server');
                    await close();
                    res.end(JSON.stringify('OK'));
                    (0, logger_1.globalInfo)('Server stopped');
                    break;
                default: {
                    res.statusCode = 404;
