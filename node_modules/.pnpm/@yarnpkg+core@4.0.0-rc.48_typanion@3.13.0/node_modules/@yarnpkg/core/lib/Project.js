...
exports.Project = exports.PeerWarningType = exports.InstallMode = void 0;
    ...
    async fetchEverything({ cache, report, fetcher: userFetcher, mode, persistProject = true }) {
        ...
        if (report.cacheMisses.size > 0 || cleanInfo) {
            const addedSizes = await Promise.all([...report.cacheMisses].map(async (locatorHash) => {
                ...
                const checksum = (_a = this.storedChecksums.get(locatorHash)) !== null && _a !== void 0 ? _a : null;
                const p = cache.getLocatorPath(locator, checksum, cacheOptions);
                const stat = p ? await fslib_2.xfs.statPromise(p) : null;
                return (_b = stat === null || stat === void 0 ? void 0 : stat.size) !== null && _b !== void 0 ? _b : 0;
            }));
            const finalSizeChange = addedSizes.reduce((sum, size) => sum + size, 0) - ((_a = cleanInfo === null || cleanInfo === void 0 ? void 0 : cleanInfo.size) !== null && _a !== void 0 ? _a : 0);
            const addedCount = report.cacheMisses.size;
            const removedCount = (_b = cleanInfo === null || cleanInfo === void 0 ? void 0 : cleanInfo.count) !== null && _b !== void 0 ? _b : 0;
...
function emitPeerDependencyWarnings(project, report) {
    ...
    const notCompatibleAggregateWarnings = (_b = (_a = warningsByType[PeerWarningType.NotCompatibleAggregate]) === null || _a === void 0 ? void 0 : _a.map(warning => {
        ...
        return `${structUtils.prettyIdent(project.configuration, warning.requested)} is listed by your project with version ${structUtils.prettyReference(project.configuration, warning.version)}, which doesn't satisfy what ${structUtils.prettyIdent(project.configuration, warning.requesters.values().next().value)} ${andDescendants} (${rangeDescription}).`;
    })) !== null && _b !== void 0 ? _b : [];
    const omittedWarnings = (_d = (_c = warningsByType[PeerWarningType.NotProvided]) === null || _c === void 0 ? void 0 : _c.map(warning => {
