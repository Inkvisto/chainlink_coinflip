...
exports.Configuration = exports.ProjectLookup = exports.coreDefinitions = exports.WindowsLinkType = exports.FormatType = exports.SettingsType = exports.SECRET = exports.DEFAULT_LOCK_FILENAME = exports.DEFAULT_RC_FILENAME = exports.ENVIRONMENT_PREFIX = exports.TAG_REGEXP = exports.LEGACY_PLUGINS = void 0;
...
class Configuration {
    ...
    static async find(startingCwd, pluginConfiguration, { lookup = ProjectLookup.LOCKFILE, strict = true, usePath = false, useRc = true } = {}) {
        ...
        const pickPrimaryCoreFields = ({ ignoreCwd, yarnPath, ignorePath, lockfileFilename, injectEnvironmentFiles }) => ({ ignoreCwd, yarnPath, ignorePath, lockfileFilename, injectEnvironmentFiles });
        const pickSecondaryCoreFields = ({ ignoreCwd, yarnPath, ignorePath, lockfileFilename, injectEnvironmentFiles, ...rest }) => {
