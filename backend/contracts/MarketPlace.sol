...
contract NFTMarketplace is ERC721URIStorage, ReentrancyGuard {
  ...
  struct MarketItem {
    ...
    function createToken(string memory tokenURI, uint256 price) public payable returns (uint) {
      ...
      function createMintedToken(uint256 tokenId, uint256 price) public payable returns (uint) {
    ...
    function createMarketItem(
      ...
      emit MarketItemCreated(
       ...
       uint256 tokenId = idToMarketItem[marketItemId].tokenId;
        ...
        require(idToMarketItem[marketItemId].seller == msg.sender, "Only item seller can perform this operation");
